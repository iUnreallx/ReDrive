...
### Сейчас весь фокус строится на разработке elm327 `эмулятора`. Проект не заброшен! Эмулятор необходим для корректного тестирования автомобиля.
```https://github.com/iUnreallx/ELM327-Emulator```
### Примерная дата окончания разработки эмулятора ~30 июня 2026
